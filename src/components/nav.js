...
<div className='border-solid mx-auto'>
    ...
    <button class="bg-blue-400 hover:bg-blue-700 hover:text-lg text-xs sm:text:sm md:text-base text-white  sm:font-bold rounded  px-1 py1 md:px-6 md:py-2"> Login </button>
