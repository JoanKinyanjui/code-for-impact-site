...
return(
  ...
  <div className='max-w-sm rounded overflow-hidden shadow-lg w-1/3 mx-auto text-center py-7'>
  ...
  <div className='max-w-sm rounded overflow-hidden shadow-lg w-1/3 pb-8 mx-auto text-center py-7' >
  <img class="w-full" src={tree} alt="Sunset in the mountains"/>
    <h6 className='font-bold  italic text-xl mb-2 font-serif'>Service Three</h6>
    <p className='text-gray-700 text-base pb-4'> An enim nullam tempor gravida donec enim ipsum blandit porta justo integer odio velna vitae auctor integer.</p>
  </div>
