...
return(
  ...
  <div className='block sm:flex py-8'>
    <div className='w-3/4 md:w-1/2 mx-auto text-center '>
        <h5 className='text-3xl font-serif md:pb-16 pb-16 pt-24 font-bold'>Market Analysis</h5>
  ...
  <div className='w-3/4 md:w-1/2 mx-auto text-center '>
        <h5 className='text-3xl font-serif md:pb-16 pb-16 pt-24 font-bold' >Search For Performance Optimization</h5>
  ...
  <div className='w-3/4 md:w-1/2 mx-auto text-center '>
        <h5 className='text-3xl font-serif md:pb-16 pb-16 pt-24 font-bold' >Design And Plan Your Business Growth Steps</h5>
