...
<SplitSection
      reverseOrder
      primarySlot={
        <div className="container mx-auto px-8 items-center flex flex-col lg:flex-row mb-8 sm:mb-16 lg:mb-0">
...
<SplitSection className="flex"
      id="services"
      primarySlot={
        <div className="container mx-auto px-16 items-center flex flex-col lg:flex-row order-last lg:order-first mb-8 sm:mb-16 lg:mb-0">
